  ...
  (/MSIE ([6789]|10)/.test(navigator.userAgent) ||
    ...
    (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init) ||
      (function(t) {
              ...
              (u.charset = 'utf-8'),
                ...
                (u.src = (function(t) {
                  return (
                    ...
                    '.' +
                    {
                      0: 'fcad8ea2acff297a366cdbcbb2a39c03',
                      2: 'f6d69ede1646796f2fe5fb27aaee5378',
                      3: '509719336ca39171c37a321231ccaf83',
                      4: 'f261877d67dc45f3972d303d6b32c138',
                      5: 'fc13e853df35d03b4cc11c06024623cd',
                ...
                return (
                  ...
                  h.length !== t.length || 0 === p.length
                    ? (c &&
                      ...
                      r.reject(
                        new Error('Not enough parameters. Expected: ' + u)
                      ))
                    : l
                    ? ((d = a.aug({}, d || {}, e)),
                    ...
                    : (c &&
                      ...
                      r.reject(
                        new Error('No target element specified. Expected: ' + u)
                      ))
                );
              }
            );
        ...
        function(t, e, n) {
          var r = n(9),
            ...
            a = function() {
              ...
              return t && s(i, t) ? t : 'https://cdn.syndication.twimg.com';
            },
            u = function() {
              var t = r.get('settingsSvcHost');
              return t && s(o, t) ? t : 'https://syndication.twitter.com';
            };
          function c(t, e) {
            var n = [t];
            return (
        ...
        function(t) {
          t.exports = {version: 'bbec9cd:1564009982483'};
        },
        function(t, e, n) {
          var r,
            i = n(10),
        ...
        function(t) {
          t.exports = {
            tweetButtonHtmlPath:
              '/widgets/tweet_button.0639d67d95b7680840758b6833f06d87.{{lang}}.html',
            followButtonHtmlPath:
              '/widgets/follow_button.0639d67d95b7680840758b6833f06d87.{{lang}}.html',
            hubHtmlPath: '/widgets/hub.html',
            widgetIframeHtmlPath:
              '/widgets/widget_iframe.0639d67d95b7680840758b6833f06d87.html',
        ...
        function(t, e, n) {
          ...
          (o.prototype.assert = function(t, e) {
            return (
              this.assertions.push({fn: t, msg: e || 'assertion failed'}), this
            );
          }),
        ...
        function(t, e, n) {
          ...
          t.exports = {
            ...
            loadPage: function() {
              ...
              return (
                h.load(),
                !1 === t ? i.resolve() : (u.set('widgets.loaded', !0), g(t))
              );
            },
          ...
          t.exports = {
            ...
            init: function() {
              return _
                ? E.promise
                : ((o = new m(a))
                    .insert('rufous-sandbox', null, {display: 'none'}, function(
                      t
                    ) {
                ...
                b()
                  .promise.then(function() {
                    e &&
                      ...
                      (r.experiments = w.aug(r.experiments, n))),
                      t.resolve(r);
                  })
                  .catch(function(e) {
                    t.reject(e);
        ...
        function(t, e, n) {
          t.exports = [n(115), n(120), n(128), n(130), n(132), n(146), n(148)];
        },
        function(t, e, n) {
          var r = n(11),
            i = n(4),
