...
!(function() {
  ...
  var e = window.document,
    ...
    d =
      c && a && a.prototype.attachShadow && !a.prototype.attachShadow.prototype,
    s = function(e, t, o) {
      e.addEventListener
    ...
    x = function(e, t, o) {
      ...
      n.styleSheet
        ...
        : n.appendChild(e.ownerDocument.createTextNode(m));
      var a,
        l,
        d = r(
          'a',
      ...
      var u,
        ...
        y = e.appendChild(
          r(
            ...
            {
              className:
                'widget' + (/^large$/i.test(t['data-size']) ? ' lg' : ''),
            },
            [d]
          )
        );
      ...
      !u[6]
        ? (u[2]
            ? ((h = '/repos/' + u[1] + '/' + u[2]),
              u[3]
                ? ((x = 'subscribers_count'), (g = 'watchers'))
                : u[4]
                ? ((x = 'forks_count'), (g = 'network'))
                : u[5]
                ? ((x = 'open_issues_count'), (g = 'issues'))
                : ((x = 'stargazers_count'), (g = 'stargazers')))
            : ((h = '/users/' + u[1]), (g = x = 'followers')),
          function(e, t) {
            var o = w[e] || (w[e] = []);
            if (!(o.push(t) > 1)) {
              var r = b(function() {
  ...
  t.protocol + '//' + t.host + t.pathname === l
    ? x(
        e.body,
        (function(e) {
          ...
          return t;
        })(window.name || t.hash.replace(/^#/, ''))
      )
    : (function(t) {
        if (
          /m/.test(e.readyState) ||
          (!/g/.test(e.readyState) && !e.documentElement.doScroll)
        )
          setTimeout(t);
